...
@synthesize myData;
@synthesize time;
@synthesize lastDropboxConnectionTry;
...
{
    [myData.appData writeToFile:@"Data.plist" atomically:YES];
    /*
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Mindfulness" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Mindfulness.sqlite"];
